...
def get_input_args():
    ...
    parser.add_argument('--dir', default='', type=str, help="set the data directory")
    parser.add_argument('--datafile', default='sample_orgs.csv', type=str, help="set the data file")
...
# Determine if org_type is company or not (note : assumed that "Community Interest Company" is not a company)
...
def test_checknoblanks():
	assert df['org_string'].isnull().values.any() == False
